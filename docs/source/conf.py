...
# -*- coding: utf-8 -*-
#
# widget_contextmenu documentation build configuration file
#
...
_version_py = os.path.join(repo, 'widget_contextmenu', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'widget_contextmenudoc'
...
latex_documents = [
    (master_doc, 'widget_contextmenu.tex', 'widget_contextmenu Documentation',
     'ian', 'manual'),
]
...
man_pages = [
    (master_doc,
    'widget_contextmenu',
    'widget_contextmenu Documentation',
     [author], 1)
]
